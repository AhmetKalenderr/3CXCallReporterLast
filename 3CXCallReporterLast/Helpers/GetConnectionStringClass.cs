...
namespace _3CXCallReporterLast.Helpers
{
    public class GetConnectionStringClass
    {
        ...
        public static string connFromPostgres { get; set; } = "server=127.0.0.1; port=5480; Database=postgres; user ID=phonesystem; password=o2EBnaSrm3hI6;" + "CommandTimeout=300;";
